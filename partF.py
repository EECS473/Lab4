...
Object detection and tracking with OpenCV
    ...
    As well as example code by Marcelo Rovai - MJRoBot.org @ 9Feb2018 
    Visit original repo: https://github.com/Mjrovai/OpenCV-Object-Face-Tracking

	Updated 9/10/24 JM for EECS 473 Lab 4
"""
...
# These may need to be adjusted depending on your camera and environment
colorLower = (80, 70, 20)
...
while True:
    ...
    # find center coordinate of frame
    h, w, _ = frame.shape
    cx = w // 2
    cy = h // 2
    ...
    # Uncomment to debug HSV threshold mask
